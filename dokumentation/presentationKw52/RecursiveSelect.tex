...
%    \begin{center}
    \begin{figure}
        ...
        \begin{lstlisting}[language=SQL,caption = SubSelect,frame=single]
        ...
        \end{lstlisting}
        \begin{lstlisting}[language=SQL,caption = Inner Join,frame=single]
    ...
    \newpage
        \begin{figure}
%            \AtPageUpperLeft{
            \begin{lstlisting}[language=SQL,caption = Stored Procedure,frame=single]
