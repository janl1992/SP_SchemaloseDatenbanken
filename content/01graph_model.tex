...
\begin{definition}
	...
	\end{itemize}
	Zwei Knoten $a,b \in V$ heißen adjazent genau dann wenn
	$\exists e \in E: \gamma(e)=\{a,b\}$. \\
	Ein Knoten $a \in V$ und eine Kante $e \in E$ heißen inzident
...
\begin{center}
	\includegraphics[scale = 0.5]{./images/Regulaere_Graphen.png}
\end{center}
