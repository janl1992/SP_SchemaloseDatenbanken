...
\newcommand{\DATE}[0]{1.10.2015}

\newcommand{\AUTHOR}[0]{Max Muster}
\newcommand{\MATNR}[0]{123456}
\newcommand{\STREET}[0]{Musterstraße 11}
\newcommand{\ZIP}[0]{12345}
\newcommand{\TOWN}[0]{Musterstadt}

\newcommand{\REFERENT}[0]{Prof. Dr. Marie Musterfrau}
\newcommand{\KOREFERENT}[0]{Prof. Dr. Max Mustermann}

\newcommand{\TITLE}[0]{Thema}
\newcommand{\COURSE}[0]{Studiengang XYZ}
\newcommand{\TYPE}[0]{Projektarbeit, Bachelor-Arbeit, Master-Arbeit}
